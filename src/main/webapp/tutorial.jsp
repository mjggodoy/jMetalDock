	...
	<div class="container">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<li>The ligand in PDBQT format. This format is widely 
				...
				complex in the viewer provided by jMetalDock. The macromolecule's PDBQT file is larger (protein) than the ligand's PDBQT file (the ligand's PDBQT file represents a chemical compound or peptide). 
				...
				<p>If the user does not provide the .zip with all the files, in the instance file field of the Task form, a list of instances from the benchmark can be selected.
				 These instances are a set of problems used as benchmark by Morris <em>et al.</em> to validate the AutoDock 4.2 energy function <a href="#Morris">[1]</a>. The instances are a set of HIV-proteases and inhibitors with different sizes (small, medium, large size and urea cycle inhibitors). A more detailed description is specified in Morris' et <emph>al.</emph> publication.
				 </p>
				...
				<dl class="dl-horizontal">
					 ...
					 <dt>A.</dt>
					 <dd>The input file option refers to the .zip file or the instance chosen by the user. The left image shows the case where user chooses one instance from the benchmark that jMetalDock server provides. 
					 The image on the right shows the case where user has to upload a .zip file with all files described above (see Input section). </dd>
					 <dt>B.</dt>
					 ...
					 <dt>E.</dt>
					 <dd>This option refers to the number of runs set by the user. The recommended number is between 50-100 runs. More executions than 100 is not very recommendable.</dd>
					 <dt>F.</dt>
					 ...
					 of a population (or particles in case the PSO algorithm). Each individual represents the codified solution (translation coordinates, rotation and torsions associated to the macromolecule and ligand)</dd>
					<dt>G.</dt>
				    <dd>The number of evaluations. It equals to the multiplication between the number of individuals of the population and the number of iterations. 
				     In the mono-objective approach, in <a href="#Camacho">[2]</a>, a study based on the convergence behavior revealed that
				...
				<br/>
				<br/>
				<img src="resources/img/results.png" alt="Results" width="700" height="450" class="center">
				<br/>	
				<br/>		
				...
				The interface shows some buttons in the Action field: "Go to results" and "Download Docking Log File". The first option refers to the set of results obtained for each run. The image below shows 
				how the results are displayed when the user clicks on "Go to results". The second option allows users 
				to visualize the .dlg file through the ADT suite (<a href="http://autodock.scripps.edu/resources/adt" target="_blank">AutoDockTools</a>). 
				...
				<br/>
				<img src="resources/img/table.png" alt="ResultsTable" width="700" height="500" class="center">
				<br/>
				<br/>
				...
				the objectives that were optimized (in this case the intermolecular and intramolecular energy) and the RMSD value associated with the solution. 
				The results' page also shows two options: "the minimum final binding energy" and "the minimum RMSD score". If the user clicks on the "run" option, all the solutions of this run are shown in the page.
				...
				<br/>
				<img src="resources/img/solution.png" alt="Solution" width="700" height="500" class="center">
				<br/>
				<br/>
				...
				<img src="resources/img/graphics.png" alt="ParetoFont" width="700" height="500" class="center">
				<br/>
				<br/>
				
				<p>The user can also visualize a solution. For doing that, the users had to submit the macromolecule's PDBQT file:</p>
				
				<img src="resources/img/complexVisualization.png" alt="PDBViewer" width="700" height="500" class="center">
