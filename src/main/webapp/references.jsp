...
<body>
	...
	<jsp:include page="/WEB-INF/jsp/header.jsp">
		<jsp:param name="page" value="references" />
	</jsp:include>
	...
	<div class="container">
		...
		<div class="starter-template">
			...
			<ul class="h5">
				...
				<li>Mar&iacute;a Jes&uacute;s Garc&iacute;a Godoy, Esteban L&oacute;pez-Camacho, Jos&eacute;
				...
				<br />
				<li>Esteban L&oacute;pez-Camacho, Mar&iacute;a Jes&uacute;s Garc&iacute;a Godoy, Jos&eacute;
					Garc&iacute;a-Nieto, Antonio J. Nebro and Jos&eacute; F. Aldana-Montes: <br />
				...
				<br/>
				<li>Esteban L&oacute;pez-Camacho, Mar&iacute;a Jes&uacute;s Garc&iacute;a Godoy, Antonio J.
			...
			<ul class="h5">
				<li>Jos&eacute; Garc&iacute;a-Nieto, Esteban L&oacute;pez-Camacho, Mar�a Jes�s
