...
<body>
	...
	<div class="container">
		<div class="page-header">
			<ol class="breadcrumb">
				...
				<li><a
					href='<c:url value="../../${solution.taskId}?token=${param.token}" />'>${solution.taskId}</a>
				</li>
				<li><a
					href='<c:url value="../../${solution.taskId}/result?token=${param.token}" />'>Results</a>
				</li>
				<li><a
					href='<c:url value="../../${solution.taskId}/result/${solution.run}?token=${param.token}" />'>
						Run ${solution.run} </a></li>
	...
	<table class="table table-striped table-condensed">
		...
		<tr>
			...
			<td class="col-md-6"><c:out value="${solution.objectives[0]}" />
